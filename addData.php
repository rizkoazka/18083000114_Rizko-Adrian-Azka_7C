    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            ...
            <div class="col-md-6 my-2 text-center link">
                ...
                <a href="https://www.facebook.com/profile.php?id=100008294763998" target="_blank"><i class="bi bi-facebook fs-3"></i></a>
                <a href="https://github.com/rizkoazka" target="_blank"><i class="bi bi-github fs-3"></i></a>
                <a href="https://www.instagram.com/rizko_azka" target="_blank"><i class="bi bi-instagram fs-3"></i></a>
                <a href="https://wa.me/6285954766781" target="_blank"><i class="bi bi-whatsapp fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created by Rizko Adrian Azka</u></p>
    </footer>
    <!-- Close Footer -->
